    ...
    public static void main(String[] args) {
        ...
        if(isCitizen || isResident){
            System.out.println("you passed first qualification");
                    if (age >= 18 && age <=35){
                System.out.println("You passed 2nd qualification");

                if (hasDiploma){
                    System.out.println("You passed final qualification. Congratulations");
                } else {
            ...
            System.out.println("Your age must be a Citizen or Resident");
        }
